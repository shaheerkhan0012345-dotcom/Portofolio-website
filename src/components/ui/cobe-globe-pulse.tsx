...
const defaultMarkers: PulseMarker[] = [
  ...
  { id: "pulse-5", location: [1.35, 103.82], delay: 2 },
  { id: "pulse-6", location: [48.85, 2.35], delay: 2.5 },
  { id: "pulse-7", location: [19.07, 72.87], delay: 0.3 },
  { id: "pulse-8", location: [-23.55, -46.63], delay: 1.2 },
  { id: "pulse-9", location: [55.75, 37.62], delay: 0.8 },
  { id: "pulse-10", location: [31.23, 121.47], delay: 1.8 },
  { id: "pulse-11", location: [37.56, 126.98], delay: 2.3 },
]
